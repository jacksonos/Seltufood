                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form action="ServletDashboard?menu=Clientes" method="post">

                                                    <div class="mb-3">
                                                        <label for="exampleInputEmail1" class="form-label">Nombres</label>
                                                        <input name="txtnombrecli" type="text" class="form-control" id="exampleInputEmail1" value="${clientetoedit.getNombres()}">
                                                    </div>

                                                    <div class="mb-3">
                                                        <label for="exampleInputEmail1" class="form-label">Apellidos</label>
                                                        <input name="txtapellidocli" type="text" class="form-control" id="exampleInputEmail1" value="${clientetoedit.getApellidos()}">
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="txtdireccioncli" type="text" class="form-control" id="exampleInputEmail1" value="${clientetoedit.getDireccion()}">
                                                    </div>

                                                    <div class="mb-3">
                                                        <label for="exampleInputEmail1" class="form-label">Correo</label>
                                                        <input name="txtemailcli" type="email" class="form-control" id="exampleInputEmail1" value="${clientetoedit.getCorreo()}">
                                                    </div>

                                                    <div class="mb-3">
                                                        <label for="exampleInputEmail1" class="form-label">Contraseña</label>
                                                        <input name="txtpasswordcli" type="password" class="form-control" id="exampleInputEmail1" value="${clientetoedit.getPassword()}">
                                                    </div>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <%                                            List<Cliente> listaclien = new ArrayList<>();
                                            listaclien = (List) request.getAttribute("clientes");

                                            for (int i = 0; i < listaclien.size(); i++) {
                                        %>
                                        <tr>

                                            <th scope="row"><%=listaclien.get(i).getIdcliente()%></th>
                                            <td><%=listaclien.get(i).getNombres()%></td>
                                            <td><%=listaclien.get(i).getApellidos()%></td>
                                            <td><%=listaclien.get(i).getGenero()%></td>
                                            <td><%=listaclien.get(i).getDireccion()%></td>
                                            <td><%=listaclien.get(i).getCorreo()%></td>
                                            <td><%=listaclien.get(i).getPassword()%></td>

                                            <td>
                                                <%if (listaclien.get(i).getEstado() == 1) {
                                            ...
                                            <td>
                                                <a href="ServletDashboard?menu=Clientes&accionmenu=Editar&id=<%=listaclien.get(i).getIdcliente()%>"><i data-feather="edit" class="mr-3" data-bs-toggle="modal" data-bs-target="#exampleModal2"></i></a>

                                                <%
                                                    if (listaclien.get(i).getEstado() == 1) {

                                                %> <a title="Desactivar" href="ServletDashboard?menu=Clientes&accionmenu=CambiarEstado&id=<%=listaclien.get(i).getIdcliente()%>"><i data-feather="eye-off" class="mr-3"></i></a><%
                                                } else {
                                                    %> <a title="Activar" href="ServletDashboard?menu=Clientes&accionmenu=CambiarEstado&id=<%=listaclien.get(i).getIdcliente()%>"><i data-feather="eye" class="mr-3"></i></a><%
                                                        }
                                                    %>



                                                <a href="ServletDashboard?menu=Clientes&accionmenu=Delete&id=<%=listaclien.get(i).getIdcliente()%>"><i data-feather="trash"></i></a>
                                            </td>
                                        </tr>
                                        <%
                                            }
