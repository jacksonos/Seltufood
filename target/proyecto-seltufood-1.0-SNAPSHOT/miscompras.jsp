<%-- 
    Document   : miscompras
    Created on : 4 dic 2021, 21:29:06
    Author     : miche
--%>
...
<html>
    <head>
        ...
        <!-- title -->
        <title>Seltufood | Mis compras</title>
                ...
                <div class="row">
                    <div class="col-lg-12 col-sm-12 text-center">
                        <div class="main-menu-wrap">
                            ...
                            <nav class="main-menu">
                                <ul>
                                    <li class="current-list-item"><a href="index.jsp">Inicio</a></li>
                            ...
                            <table class="cart-table">
                                <thead class="cart-table-head">
                                    <tr class="table-head-row">
                                        ...
                                        <th class="product-name">Fecha de la compra</th>
                                        <th class="product-price">Monto</th>
                                        <th class="product-quantity">Código de pago</th>
                                        <th class="product-total">Estado</th>
                                        <th></th>
                                    </tr>
                                </thead>
                                <tbody>

                                    <c:forEach var="mycom" items="${myCompras}">

                                        <tr class="table-body-row">
                                            <td class="product-name" style="min-width: 150px">C00${mycom.getIdcompra()}</td>
                                            <td class="product-name" style="min-width: 150px">${mycom.getFechacompra()}</td>
                                            <td class="product-price">
                                                $.${mycom.getMonto()}
                                            </td>
                                            <td class="product-name" style="min-width: 150px">P00${mycom.getIdpago()}</td>
                                            <td class="product-name" style="min-width: 250px"><strong>${mycom.getEstado()}</strong></td>
                                            <td class="product-name" style="min-width: 120px">
                                                <a class="btn btn-dark rounded-pill" href="Controlador?accion=verDetalle&idcompra=${mycom.getIdcompra()}">Ver Detalle</a>
                                            </td>
