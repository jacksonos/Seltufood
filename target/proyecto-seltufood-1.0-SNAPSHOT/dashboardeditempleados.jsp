<%@page import="bean.Tipo_empleado"%>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                    <i class="material-icons-two-tone align-middle" data-feather="plus-circle"></i><label class="ml-2 align-middle">Nuevo empleado</label>
                                </button>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form action="ServletDashboard?menu=Empleados" method="post">

                                                    <div class="mb-3">
                                                        <label for="exampleInputPassword1" class="form-label">Género</label>
                                                        <select class="form-control" name="selectgenerocli">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="txtnombrempleado" type="text" class="form-control" id="exampleInputEmail1" value="${empleadotoedit.getNombre()}">
                                                    </div>

                                                    <div class="mb-3">
                                                        <label for="exampleInputEmail1" class="form-label">Apellidos</label>
                                                        <input name="txtapellidoempleado" type="text" class="form-control" id="exampleInputEmail1" value="${empleadotoedit.getApellido()}">
                                                    </div>

                                                    <div class="mb-3">
                                                        <label for="exampleInputPassword1" class="form-label">Género</label>
                                                        <select class="form-control" name="selecttipoemp">
                                                             <%
                                                                 List<Tipo_empleado> listita = new ArrayList<>();
                                                                listita = (List) request.getAttribute("tipoempleados");;
                                                                for (int i = 0; i < listita.size(); i++) {
                                                            %><option value="<%=listita.get(i).getIdtipo_empleado() %>"><%=listita.get(i).getNombre()%><%
                                                                }
                                                                %>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input value="${empleadotoedit.getTelefono()}" name="txtelefonoempleado" type="text" maxlength="9" minlength="9" class="form-control" id="exampleInputEmail1" value="">
                                                    </div>

                                                    <div class="mb-3">
                                                        <label for="exampleInputEmail1" class="form-label">Correo electrónio</label>
                                                        <input name="txtemailempleado" type="email" class="form-control" id="exampleInputEmail1" value="${empleadotoedit.getCorreo()}">
                                                    </div>

                                                    <div class="mb-3">
                                                        <label for="exampleInputEmail1" class="form-label">Contraseña</label>
                                                        <input name="txtpasswordempleado" type="password" class="form-control" id="exampleInputEmail1" value="${empleadotoedit.getPassword()}">
                                                    </div>

                                                    <div class="mb-3">
                                                        <label for="exampleInputPassword1" class="form-label">Estado</label>
                                                        <select class="form-control" name="selectestadocli">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <%
                                            ...
                                            listaemp = (List) request.getAttribute("empleados");

                                            for (int i = 0; i < listaemp.size(); i++) {
                                        %>
                                        <tr>

                                            <th scope="row"><%=listaemp.get(i).getIdempleado()%></th>
                                            <td><%=listaemp.get(i).getTipo_empleado().getNombre()%></td>
                                            <td><%=listaemp.get(i).getNombre()%></td>
                                            <td><%=listaemp.get(i).getApellido()%></td>
                                            <td><%=listaemp.get(i).getGenero()%></td>
                                            <td><%=listaemp.get(i).getTelefono()%></td>
                                            <td><%=listaemp.get(i).getCorreo()%></td>
                                            <td><%=listaemp.get(i).getPassword()%></td>

                                            <td>
                                                <%if (listaemp.get(i).getEstado() == 1) {
                                            ...
                                            <td>
                                                <a href="ServletDashboard?menu=Empleados&accionmenu=Editar&id=<%=listaemp.get(i).getIdempleado()%>"><i data-feather="edit" class="mr-3" data-bs-toggle="modal" data-bs-target="#exampleModal2"></i></a>

                                                <%
                                                    if (listaemp.get(i).getEstado() == 1) {

                                                %> <a title="Desactivar" href="ServletDashboard?menu=Empleados&accionmenu=CambiarEstado&id=<%=listaemp.get(i).getIdempleado()%>"><i data-feather="eye-off" class="mr-3"></i></a><%
                                                } else {
                                                    %> <a title="Activar" href="ServletDashboard?menu=Empleados&accionmenu=CambiarEstado&id=<%=listaemp.get(i).getIdempleado()%>"><i data-feather="eye" class="mr-3"></i></a><%
                                                        }
                                                    %>



                                                <a href="ServletDashboard?menu=Empleados&accionmenu=Delete&id=<%=listaemp.get(i).getIdempleado()%>"><i data-feather="trash"></i></a>
                                            </td>
                                        </tr>
                                        <%
                                            }
