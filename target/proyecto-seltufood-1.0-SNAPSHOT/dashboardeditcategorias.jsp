                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form action="ServletDashboard?menu=CategoriaPlatillos" method="post">
                                                    <div class="mb-3">
                                                        <label for="exampleInputEmail1" class="form-label">Nombre</label>
                                                        <input name="txtnombrecat" type="text" class="form-control" id="exampleInputEmail1" value="${cate_platedtoit.getNombre()}">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="exampleInputPassword1" class="form-label">Estado</label>
                                                        <select class="form-control" name="selectactiv">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <%
                                            ...
                                            listacat_plat = (List) request.getAttribute("categ_platillo");

                                            for (int i = 0; i < listacat_plat.size(); i++) {
                                        %>
                                        <tr>

                                            <th scope="row"><%=listacat_plat.get(i).getIdCategoria()%></th>
                                            <td><%=listacat_plat.get(i).getNombre()%></td>
                                            <td>
                                                <%if (listacat_plat.get(i).getEstado() == 1) {
                                            ...
                                            <td>
                                                <a href="ServletDashboard?menu=CategoriaPlatillos&accionmenu=Editar&id=<%=listacat_plat.get(i).getIdCategoria()%>"><i data-feather="edit" class="mr-3" data-bs-toggle="modal" data-bs-target="#exampleModal2"></i></a>

                                                <%
                                                    if (listacat_plat.get(i).getEstado() == 1) {
                                                %> <a title="Desactivar" href="ServletDashboard?menu=CategoriaPlatillos&accionmenu=CambiarEstado&id=<%=listacat_plat.get(i).getIdCategoria()%>"><i data-feather="eye-off" class="mr-3"></i></a><%
                                                } else {
                                                    %> <a title="Activar" href="ServletDashboard?menu=CategoriaPlatillos&accionmenu=CambiarEstado&id=<%=listacat_plat.get(i).getIdCategoria()%>"><i data-feather="eye" class="mr-3"></i></a><%
                                                        }
                                                    %>



                                                <a href="ServletDashboard?menu=CategoriaPlatillos&accionmenu=Delete&id=<%=listacat_plat.get(i).getIdCategoria()%>"><i data-feather="trash"></i></a>
                                            </td>
                                        </tr>
                                        <%
                                            }
